  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4'>
        ...
        <input type="text" placeholder={currentUser.username} id='username' className='border p-3 rounded-lg' />
        <input type="email" placeholder={currentUser.email} id='email' className='border p-3 rounded-lg' />
